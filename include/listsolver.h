...
protected:
        ...
        bool check_allocating_plans(graph& g_phi, graph& g_psi, z3::expr& phi_abs);

        // match
        virtual bool match_graph(graph& psi_g, graph& omega_g_i);
        ...
        // construct graph
        void construct_graph(std::vector<z3::expr>& lconsts, std::vector<int>& lconst_class, std::vector<std::set<int> >& eq_class_vec, z3::expr& space, graph& g);
